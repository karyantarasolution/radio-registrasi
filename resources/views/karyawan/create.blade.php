...
<div class="container">
    ...
    <div class="card border-0 shadow-sm mb-4 rounded-3">
        <div class="card-body d-flex justify-content-between align-items-center">
            <div>
                <h4 class="fw-bold text-danger mb-1">Tambah Data Karyawan</h4>
                <small class="text-muted">Form input data karyawan ICT</small>
            </div>
            ...
            <form action="{{ route('karyawan.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        <label class="form-label fw-semibold">Upload QR Code (Opsional)</label>
