...
<div class="container">
    ...
    <div class="card border-0 shadow-sm mb-4 rounded-3">
        <div class="card-body d-flex justify-content-between align-items-center">
            <div>
                <h4 class="fw-bold text-danger mb-1">Edit Inspeksi Stavolt</h4>
                <small class="text-muted">Form edit data inspeksi perangkat stavolt</small>
            </div>
        ...
        <div class="card-body">
            ...
            <form action="{{ route('inspeksistavolt.update', $inspeksistavolt) }}" method="POST">
                ...
                <div class="d-flex justify-content-end mt-4">
                    ...
                    <a href="{{ route('inspeksistavolt.index') }}" class="btn btn-outline-secondary fw-bold">
                        Batal
                    </a>
                </div>
            </form>
