...
{{-- Semua CSS dan style sama persis --}}
<style>
    body {
...
<div class="form-wrapper">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('registrasi.update', $registrasi->id) }}" method="POST" id="radioForm">
                @csrf
                @method('PUT')
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="perusahaan" class="form-control"
                           value="{{ old('perusahaan', $registrasi->perusahaan) }}" required>
                </div>

                <div class="form-group">
                    <label class="form-label">Nomor Lambung</label>
                    <input type="text" name="nomor_lambung" class="form-control"
                           value="{{ old('nomor_lambung', $registrasi->nomor_lambung) }}" required>
                </div>

                <div class="form-group">
                    <label class="form-label">Jenis Kendaraan</label>
                    <input type="text" name="jenis_kendaraan" class="form-control"
                           value="{{ old('jenis_kendaraan', $registrasi->jenis_kendaraan) }}" required>
                </div>

                <div class="form-group">
                    <label class="form-label">Nomor Polisi</label>
                    <input type="text" name="nomor_polisi" class="form-control"
                           value="{{ old('nomor_polisi', $registrasi->nomor_polisi) }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="serial_number" class="form-control"
                           value="{{ old('serial_number', $registrasi->serial_number) }}">
                </div>
                ...
                <div class="form-group">
                   ...
                   @php
                    ...
                    // PERBAIKAN UTAMA
                    $channelsChecked = is_array($registrasi->channels)
                        ? $registrasi->channels
                        : json_decode($registrasi->channels, true);
                @endphp
                @foreach($channels as $ch)
                    <div class="form-check form-check-inline">
                        <input class="form-check-input"
                            ...
                            value="{{ $ch }}"
                            id="ch_{{ Str::slug($ch) }}"
                            {{ in_array($ch, $channelsChecked ?? []) ? 'checked' : '' }}>
                        <label class="form-check-label" for="ch_{{ Str::slug($ch) }}">
                            {{ $ch }}
                        </label>
                    </div>
                @endforeach
