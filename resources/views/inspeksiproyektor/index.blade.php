    ...
    <div class="container-fluid">
        ...
        <div class="page-header" data-aos="fade-down">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h2 class="fw-bold mb-1">📽️ Inspeksi Proyektor</h2>
                    <p class="mb-0">Kelola data hasil inspeksi perangkat Proyektor</p>
                    <small>PT. Putra Perkasa Abadi</small>
                </div>
                <div class="col-md-4 text-end">
                    <a href="{{ route('inspeksiproyektor.create') }}" class="btn btn-add btn-modern">
        ...
        <div class="row g-3 mb-3">
            ...
            <div class="col-6 col-md-2-4">
                <div class="stat-card">
                    ...
                    <div class="stat-number">{{ $data->pluck('departemen')->unique()->count() }}</div>
...
<div class="card shadow-sm border-0 rounded-4 mb-4">
    <div class="card-body">
        ...
        <form method="GET" action="{{ route('inspeksiproyektor.index') }}" class="row g-3 align-items-end">
            ...
            <div class="col-md-2 d-grid gap-2">
                ...
                <a href="{{ route('inspeksiproyektor.index') }}" class="btn btn-riset fw-bold rounded-3">
                    Reset
                </a>
            </div>
        ...
        <div class="table-card" data-aos="fade-up">
            <div class="table-header">
                <h4 class="table-title">📋 Data Inspeksi Proyektor</h4>
                ...
                <table class="table-custom">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('inspeksiproyektor.edit', $row->id) }}" class="btn btn-edit btn-modern">Edit</a>
                                <a href="{{ route('inspeksiproyektor.report', $row->id) }}" 
                                   class="btn btn-pdf btn-modern" target="_blank">PDF</a>
                                <form action="{{ route('inspeksiproyektor.destroy', $row->id) }}" method="POST" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
            ...
            <div class="table-actions">
                <div>
                    <a href="{{ route('inspeksiproyektor.export.excel') }}" class="btn btn-excel btn-modern">
