        ...
        <div class="card-body">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="inspektor" class="form-control" 
                    value="{{ old('inspektor', $inspeksiproyektor->inspektor ?? '') }}">
            </div>

            <div class="mb-3">
                <label class="form-label">Jabatan Inspektor</label>
                <input type="text" name="jabatan_inspektor" class="form-control" 
                    value="{{ old('jabatan_inspektor', $inspeksiproyektor->jabatan_inspektor ?? '') }}">
            </div>

            <div class="mb-3">
                <label class="form-label">Diketahui Oleh</label>
                <input type="text" name="diketahui_oleh" class="form-control" 
                    value="{{ old('diketahui_oleh', $inspeksiproyektor->diketahui_oleh ?? '') }}">
            </div>
        </div>
    </div>
</div>
