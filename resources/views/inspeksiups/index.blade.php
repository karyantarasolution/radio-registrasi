    ...
    <div class="container-fluid">
        ...
        <div class="page-header" data-aos="fade-down">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h2 class="fw-bold mb-1">🔋  Inspeksi UPS</h2>
                    <p class="mb-0">Kelola data hasil inspeksi perangkat UPS</p>
                    <small>PT. Putra Perkasa Abadi</small>
                </div>
                <div class="col-md-4 text-end">
                    <a href="{{ route('inspeksiups.create') }}" class="btn btn-add btn-modern">
    ...
    <div class="card-body">
        ...
        <div class="table-card" data-aos="fade-up">
            <div class="table-header">
                <h4 class="table-title">📋 Data Inspeksi UPS</h4>
                ...
                <table class="table-custom">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('inspeksiups.edit', $row->id) }}" class="btn btn-edit btn-modern">Edit</a>
                                <a href="{{ route('inspeksiups.report', $row->id) }}" 
                                    class="btn btn-pdf btn-modern" target="_blank">
                                    PDF
                                </a>
                                <form action="{{ route('inspeksiups.destroy', $row->id) }}" method="POST" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
            ...
            <div class="table-actions">
                <div>
                    <a href="{{ route('inspeksiups.export.excel') }}" class="btn btn-excel btn-modern">
