...
<head>
<meta charset="utf-8"/>
<title>Laporan Barang Baru</title>
<style>
...
<table class="bordered">
    <tr><th colspan="8" class="section-title">DAFTAR BARANG BARU (30 HARI TERAKHIR)</th></tr>
    <tr>
    ...
    @empty
    <tr><td colspan="8">Tidak ada barang baru dalam 30 hari terakhir</td></tr>
    @endforelse
</table>
...
<div style="margin-top:10px;">
    ...
    <div style="min-height:50px; border:1px solid #000; padding:6px;">
        Barang yang masuk gudang IT dalam periode 30 hari terakhir.
