...
<body>
    <div class="login-card">
        <div class="login-header">
            ...
            <h1 class="login-title">Login Admin ICT</h1>
            <p class="login-subtitle">Masukkan kredensial administrator</p>
        </div>
        ...
        <form method="POST" action="{{ route('login.post') }}">
            ...
            <div class="form-group">
                ...
                <input id="name" type="text" name="name" class="form-input" placeholder="Masukkan nama pengguna" value="{{ old('name') }}" required autofocus />
                @error('name') <p class="error-msg">{{ $message }}</p> @enderror
            </div>

            <div class="form-group">
                <label for="password" class="form-label">Kata Sandi</label>
                <input id="password" type="password" name="password" class="form-input" placeholder="Masukkan kata sandi" required autocomplete="current-password" />
