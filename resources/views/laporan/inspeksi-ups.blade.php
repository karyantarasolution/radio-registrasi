    ...
    <div class="container-fluid">
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h2 class="fw-bold mb-1"><i class="fas fa-car-battery me-2"></i>Laporan Inspeksi UPS</h2>
                    <p class="mb-0">Daftar seluruh data inspeksi perangkat UPS</p>
        ...
        <div class="stat-row">
            <div class="stat-mini">
                <div class="num" style="color:#f39c12;">{{ $data->total() }}</div>
        ...
        <div class="table-card">
            <div class="table-header">
                <h4 style="font-weight:bold; margin:0;">📋 Data Inspeksi UPS</h4>
                <div>
                    <a href="{{ route('inspeksiups.export.excel') }}" class="btn btn-excel btn-modern" target="_blank">
