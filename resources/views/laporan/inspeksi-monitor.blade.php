    ...
    <div class="container-fluid">
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h2 class="fw-bold mb-1"><i class="fas fa-tv me-2"></i>Laporan Inspeksi Monitor / TV</h2>
                    <p class="mb-0">Daftar seluruh data inspeksi monitor dan TV</p>
        ...
        <div class="stat-row">
            <div class="stat-mini">
                <div class="num" style="color:#9b59b6;">{{ $data->total() }}</div>
        ...
        <div class="table-card">
            <div class="table-header">
                <h4 style="font-weight:bold; margin:0;">📋 Data Inspeksi Monitor / TV</h4>
                <div>
                    <a href="{{ route('inspeksimonitor.export.excel') }}" class="btn btn-excel btn-modern" target="_blank">
