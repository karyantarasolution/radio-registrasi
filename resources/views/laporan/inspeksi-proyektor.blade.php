    ...
    <div class="container-fluid">
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h2 class="fw-bold mb-1"><i class="fas fa-video me-2"></i>Laporan Inspeksi Proyektor</h2>
                    <p class="mb-0">Daftar seluruh data inspeksi proyektor</p>
        ...
        <div class="stat-row">
            <div class="stat-mini">
                <div class="num" style="color:#1abc9c;">{{ $data->total() }}</div>
                <div class="lbl">Total Data</div>
            </div>
            <div class="stat-mini">
                <div class="num" style="color:#2980b9;">{{ $data->pluck('departemen')->unique()->count() }}</div>
        ...
        <div class="table-card">
            <div class="table-header">
                <h4 style="font-weight:bold; margin:0;">📋 Data Inspeksi Proyektor</h4>
                <div>
                    <a href="{{ route('inspeksiproyektor.export.excel') }}" class="btn btn-excel btn-modern" target="_blank">
