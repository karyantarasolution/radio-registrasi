    ...
    <div class="container-fluid">
        <div class="page-header d-flex justify-content-between align-items-center flex-wrap gap-2">
            ...
            <div class="d-flex gap-2">
                <a href="{{ route('pimpinan.laporan.pdf.peminjaman', request()->only(['status','tanggal_awal','tanggal_akhir','q'])) }}" class="btn btn-danger btn-sm fw-bold" target="_blank">
        ...
        <form method="GET" action="{{ route('pimpinan.laporan.peminjaman') }}" class="bg-white rounded-3 p-3 shadow-sm mb-3">
            <div class="row g-2 align-items-end">
                <div class="col-md-2">
                    <label class="form-label small mb-1 fw-semibold">Status</label>
                    <select name="status" class="form-select form-select-sm">
                        <option value="">Semua</option>
                        @foreach(['Pending', 'Menunggu Persetujuan', 'Belum Dikembalikan', 'Pending Pengembalian', 'Dikembalikan'] as $st)
                ...
                <div class="col-md-3">
                    <label class="form-label small mb-1 fw-semibold">Cari (Nama / NRP / Perangkat)</label>
                ...
                <div class="col-auto">
                    ...
                    <a href="{{ route('pimpinan.laporan.peminjaman') }}" class="btn btn-outline-secondary btn-sm">Reset</a>
                </div>
            </div>
        </form>
