...
<head>
<meta charset="utf-8"/>
<title>Laporan Inspeksi Monitor / TV</title>
<style>
...
<table style="width:100%; margin-bottom:8px;">
    <tr>
        ...
        <td style="width:55%; text-align:center;">
            <h3>LAPORAN INSPEKSI MONITOR / TV</h3>
            <div>ICT (Information Communication & Technology)</div>
        </td>
        <td style="width:35%;">
            <table style="width:100%; border-collapse:collapse;">
                <tr><td>No. Dokumen</td><td>: PPA-ADRO-F-ICT-18</td></tr>
...
<table class="bordered">
    <tr><th colspan="10" class="section-title">DAFTAR INSPEKSI MONITOR / TV</th></tr>
    <tr>
    ...
    @empty
    <tr><td colspan="10">Belum ada data inspeksi Monitor / TV</td></tr>
    @endforelse
</table>
