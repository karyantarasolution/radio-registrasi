    ...
    <div class="container-fluid">
        ...
        <div class="page-header" data-aos="fade-down">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h2 class="fw-bold mb-1">🖥️ Inspeksi Monitor / TV</h2>
                    <p class="mb-0">Kelola data hasil inspeksi perangkat Monitor / TV</p>
                    <small>PT. Putra Perkasa Abadi</small>
                </div>
                <div class="col-md-4 text-end">
                    <a href="{{ route('inspeksimonitor.create') }}" class="btn btn-add btn-modern">
...
<div class="card shadow-sm border-0 rounded-4 mb-4">
    <div class="card-body">
        ...
        <form method="GET" action="{{ route('inspeksimonitor.index') }}" class="row g-3 align-items-end">
            ...
            <div class="col-md-2 d-grid gap-2">
                ...
                <a href="{{ route('inspeksimonitor.index') }}" class="btn btn-riset fw-bold rounded-3">
                    Reset
                </a>
            </div>
        ...
        <div class="table-card" data-aos="fade-up">
            <div class="table-header">
                <h4 class="table-title">📋 Data Inspeksi Monitor / TV</h4>
                ...
                <table class="table-custom">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('inspeksimonitor.edit', $row->id) }}" class="btn btn-edit btn-modern">Edit</a>
                                <a href="{{ route('inspeksimonitor.report', $row->id) }}" 
                                    class="btn btn-pdf btn-modern" target="_blank">
                                    PDF
                                </a>
                                <form action="{{ route('inspeksimonitor.destroy', $row->id) }}" method="POST" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
            ...
            <div class="table-actions">
                <div>
                    <a href="{{ route('inspeksimonitor.export.excel') }}" class="btn btn-excel btn-modern">
